<template>
    <div class="page">
        <div class="head">
            <div class="left">
                <img :src="articleDetail.organizationImgUrl" alt="">
                <div class="name">
                    <span class="title">{{articleDetail.organizationName}}</span>
                    <span class="desc">{{articleDetail.organizationDesc}}</span>
                </div>
            </div>
            <followBtn :followId="articleDetail.organizationId" :followStatus="articleDetail.followStatus" type="1"></followBtn>
        </div>
        <div class="img">
...
export default {
    ...
    methods: {
        detail () {
            this.$http.post('/organization/article/detail', {
